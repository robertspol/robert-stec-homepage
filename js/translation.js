...
const translationButton = document.querySelector(
    ".top-buttons-wrapper__translate"
);

const aboutNameSection = document.querySelector(".about .main__section-name");
const textAbout = document.querySelector(".about p");

const projectMagicOfScienceName = document.querySelector(
    ".portfolio__project-name--magic-of-science"
);
const projectGamesName = document.querySelector(
...
const gamesDescription = document.querySelector(
    ".portfolio__description--games"
);
const chatDescription = document.querySelector(".portfolio__description--chat");
const englishLanguageSchoolDescription = document.querySelector(
    ".portfolio__description--english-language-school"
);
const rysiuTaxiStrzegomDescription = document.querySelector(
    ".portfolio__description--rysiu-taxi-strzegom"
);
const rozrywkolandDescription = document.querySelector(
    ".portfolio__description--rozrywkoland"
);
...
const translateIntoEnglish = () => {
    ...
    gamesDescription.textContent =
        "Two games with the option to create an account and save game progress";
    chatDescription.textContent = "Online messenger";
    englishLanguageSchoolDescription.textContent =
        "Website of a non-existent English language school with an interactive dictionary containing basic expressions and an automated gallery with the option for manual operation";
    rysiuTaxiStrzegomDescription.textContent =
        "Taxi driver's website business card";
    rozrywkolandDescription.textContent =
        "Website business card for a company offering entertainment and medical services";
...
const translateIntoPolish = () => {
    ...
    gamesDescription.textContent =
        "Dwie gry z możliwością założenia konta oraz zapisywania stanu rozgrywki";
    chatDescription.textContent = "Komunikator internetowy";
    englishLanguageSchoolDescription.textContent =
        "Strona internetowa nieistniejącej szkoły języka angielskiego z interaktywnym słownikiem zawierającym podstawowe wyrażenia i zautomatyzowaną galerią z możliwością ręcznego operowania";
    rysiuTaxiStrzegomDescription.textContent =
        "Strona internetowa-wizytówka kierowcy taksówki";
    rozrywkolandDescription.textContent =
        "Strona internetowa-wizytówka firmy oferującej usługi rozrywkowe oraz medyczne";
