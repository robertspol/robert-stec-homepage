...
const projectGryName = document.querySelector('.portfolio__project-name--gry');

const gryDescription = document.querySelector('.portfolio__description--gry');
...
const translateIntoEnglish = () => {
    ...
    projectGryName.textContent = 'Games';

    gryDescription.textContent = 'Two games with the option to create an account and save game progress';
...
const translateIntoPolish = () => {
    ...
    projectGryName.textContent = 'Gry';

    gryDescription.textContent = 'Dwie gry z możliwością założenia konta oraz zapisywania stanu rozgrywki';
